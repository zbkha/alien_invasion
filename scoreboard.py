...
class Scoreboard:
    ...
    def prep_score(self):
        ...
        self.score_image = self.font.render(self.score, True, self.text_color, self.ai_settings.bg_color)
    ...
    def prep_high_score(self):
        ...
        self.high_score_image = self.font.render(self.high_score, True, self.text_color, self.ai_settings.bg_color)
